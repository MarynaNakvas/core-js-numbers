...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  ...
  return Math.acos(scalar / (firstVectorModule * secondVectorModule));
}
...
function getFibonacciNumber(index) {
  ...
  const firstPreviousNumber = getFibonacciNumber(index - 1);
  const secondPreviousNumber = getFibonacciNumber(index - 2);
